...
import 'package:flutter_animated_dialog_devcooljoe/flutter_animated_dialog_devcooljoe.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return CustomDialogWidget(
      title: titleText != null
          ...
          : null,
      content: content != null ? SizedBox.shrink() : null,
      actions: actions ??
          [
            onNegativeClick != null
                ? TextButton(
                    ...
                    child: Text(
                      negativeText ?? 'cancel',
                      style: negativeTextStyle ?? TextStyle(color: Theme.of(context).textTheme.overline.color, fontSize: Theme.of(context).textTheme.button.fontSize),
                    ),
                  )
                : null,
            onPositiveClick != null
                ? TextButton(
                    ...
                    child: Text(
                      ...
                      style: positiveTextStyle ?? TextStyle(color: Theme.of(context).primaryColor, fontSize: Theme.of(context).textTheme.button.fontSize),
                    ),
                  )
                : null,
          ],
            ...
            widget.onNegativeClick != null
                ? TextButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: Theme.of(context).textTheme.overline.color, fontSize: Theme.of(context).textTheme.button.fontSize),
                    ),
                  )
                : null,
            TextButton(
              ...
              child: Text(
                ...
                style: TextStyle(color: Theme.of(context).primaryColor, fontSize: Theme.of(context).textTheme.button.fontSize),
              ),
            ),
          ],
      elevation: 0.0,
